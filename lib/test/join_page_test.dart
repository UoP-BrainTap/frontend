...
void main() {
  group('JoinSessionPage Widget Tests', () {
    ...
    testWidgets('Renders input field and join button correctly', (WidgetTester tester) async {
    ...
    testWidgets('Displays error message if session code is empty', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Provider<Dio>(
            create: (_) => Dio(),
    ...
    testWidgets('Calls API and navigates on valid session code', (WidgetTester tester) async {
